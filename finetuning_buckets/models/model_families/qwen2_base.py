...
qwen2_system_prompt = "You are a helpful assistant." # source: https://huggingface.co/Qwen/Qwen2-7B-Instruct 

# Concat two prompts
default_system_prompt = f"{qwen2_system_prompt} {default_system_prompt}"
...
class Qwen2StringConverter:
    ...
    def string_formatter(example):
        # parsing openai style chatting format to the string format used in qwen2
